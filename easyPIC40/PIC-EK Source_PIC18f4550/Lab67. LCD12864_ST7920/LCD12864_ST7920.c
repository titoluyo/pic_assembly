...
#define Rs  RB0 //COMMNAD/DATA SELECT 
#define RW  RB1 //READ/WRITE SELECT 
#define E   RB2 //ENABLE SIGNAL 
#define Psb RB3 //PARALLEL/SERIAL SELECT（H/L）
#define Rst RB5 //RESET SIGNAL
