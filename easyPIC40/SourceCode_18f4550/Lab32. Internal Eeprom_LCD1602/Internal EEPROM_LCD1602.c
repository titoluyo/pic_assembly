...
void main(void)
{
	...
	ADCON1=0X0f;            
 	TRISA=0B11000000;   		
	TRISD=0B00000000;   	  
	buf=eeprom_read(0x10);	   
	buf++;
	eeprom_write(0x10,buf);    
	...
	lcd_write_char(4,0,'P');   //P
	lcd_write_char(5,0,'R');   //R   
	lcd_write_char(6,0,'O');   //O  	
	lcd_write_char(7,0,'M');   //M

	lcd_write_char(9,0,'T');  //T
	lcd_write_char(10,0,'E');  //E
	lcd_write_char(11,0,'S');  //S
	lcd_write_char(12,0,'T');  //T
	lcd_write_char(13,0,'-');   //-
	lcd_write_char(14,0,'-');   //-
